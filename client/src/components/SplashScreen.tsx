...
export const SplashScreen: React.FC<SplashScreenProps> = ({ onFinish }) => {
  ...
  if (!show) {
    return (
      <div className="fixed inset-0 bg-[#1A0600] z-[9999] transition-opacity duration-500 opacity-0 pointer-events-none" />
    );
  }

  return (
    <div className="fixed inset-0 z-[9999] flex flex-col transition-opacity duration-500 overflow-hidden bg-gradient-to-b from-[#1A0600] via-[#240A00] to-[#120400]">
